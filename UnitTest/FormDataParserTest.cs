...
namespace UnitTest
{
    ...
    public class FormDataParserTest
    {
        ...
        [TestCase("------WebKitFormBoundaryTI6BAlLenD9hAfOv\r\nContent-Disposition: form-data; name=\"action\"\r\n\r\ncheck\r\n------WebKitFormBoundaryTI6BAlLenD9hAfOv--\r\n", "check")]
        [TestCase("------WebKitFormBoundaryTI6BAlLenD9hAfOv\r\nContent-Disposition: form-data; name=\"action2\"\r\n\r\ncheck\r\n------WebKitFormBoundaryTI6BAlLenD9hAfOv--\r\n", "NoAction")]
        [TestCase("------WebKitFormBoundaryTI6BAlLenD9hAfOv\r\nContent-Disposition: form-data; name=\"action\"\r\n\r\nversion\r\n------WebKitFormBoundaryTI6BAlLenD9hAfOv--\r\n", "version")]
        [TestCase("------WebKitFormBoundaryVo7cTQkE4yPez0iz\r\nContent-Disposition: form-data; name=\"action\"\r\n\r\nbet_request\r\n------WebKitFormBoundaryVo7cTQkE4yPez0iz\r\nContent-Disposition: form-data; name=\"game_state\"\r\n\r\n{   \"players\":[     {       \"name\":\"Player 1\",       \"stack\":1000,       \"status\":\"active\",       \"bet\":0,       \"hole_cards\":[],       \"version\":\"Version name 1\",       \"id\":0     },     {       \"name\":\"Player 2\",       \"stack\":1000,       \"status\":\"active\",       \"bet\":0,       \"hole_cards\":[],       \"version\":\"Version name 2\",       \"id\":1     }   ],   \"small_blind\":10,   \"orbits\":0,   \"dealer\":0,   \"community_cards\":[],   \"current_buy_in\":0,   \"pot\":0 }\r\n------WebKitFormBoundaryVo7cTQkE4yPez0iz--\r\n", "bet_request")]
        [TestCase("------WebKitFormBoundaryVo7cTQkE4yPez0iz\r\nContent-Disposition: form-data; name=\"action\"\r\n\r\nshowdown\r\n------WebKitFormBoundaryVo7cTQkE4yPez0iz\r\nContent-Disposition: form-data; name=\"game_state\"\r\n\r\n{   \"players\":[     {       \"name\":\"Player 1\",       \"stack\":1000,       \"status\":\"active\",       \"bet\":0,       \"hole_cards\":[],       \"version\":\"Version name 1\",       \"id\":0     },     {       \"name\":\"Player 2\",       \"stack\":1000,       \"status\":\"active\",       \"bet\":0,       \"hole_cards\":[],       \"version\":\"Version name 2\",       \"id\":1     }   ],   \"small_blind\":10,   \"orbits\":0,   \"dealer\":0,   \"community_cards\":[],   \"current_buy_in\":0,   \"pot\":0 }\r\n------WebKitFormBoundaryVo7cTQkE4yPez0iz--\r\n", "showdown")]
